  ...
  return (
    <React.Fragment>
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
        ...
        <TableCell align="right">{Number(row.Ltp).toFixed(2)}</TableCell>
      </TableRow>
      <TableRow>
              ...
              <Table size="small" aria-label="purchases">
                ...
                <TableBody>
                  <TableRow key={row.IndexName}>
                    ...
                    <TableCell>{Number(row.Beta).toFixed(2)}</TableCell>
                    <TableCell align="right">
                      {Number(row.Pb).toFixed(2)}
                    </TableCell>
                    <TableCell align="right">
                      {Number(row.Rsi).toFixed(2)}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
        ...
        <div>
          <TableContainer sx={{ maxHeight: 400 }}>
            <Table stickyHeader aria-label="collapsible table">
              ...
              <TableBody>
                {indexData.map((row: IndexInterface) => {
                  return <Row key={row.IndexName} row={row} />;
                })}
              </TableBody>
            </Table>
          </TableContainer>
